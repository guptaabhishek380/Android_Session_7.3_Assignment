package com.abhi380.gupta.assignment_73;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (db.checkDB()) { //default entry
            Bitmap photo = BitmapFactory.decodeResource(getResources(), R.drawable.abhishek);
            byte photoBytes[] = getBytes(photo);
            Employee employee = new Employee("abhishek",60,photoBytes);
